= soapui-runner-example image:https://travis-ci.org/daggerok/soapui-runner-example.svg?branch=5.3.0-apply-plugin["Build Status", link="https://travis-ci.org/daggerok/soapui-runner-example"]
